...
import image from "../asset/glass.jpg"
  ...
  return (
    <div>
      <div className='w-11/12 m-auto py-10'>
        <h1 className='text-3xl text-left font-bold'  >Shopping Cart</h1>
        <p className='text-sm text-gray-400   text-left'>There are 1 Items in your cart</p>
